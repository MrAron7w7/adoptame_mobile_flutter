...
//limpiar recursos cuando no se ocupe
  ...
  void _signUp() async {
    ...
    try {
      ...
      if (user != null) {
        String defaultProfile = 'https://firebasestorage.googleapis.com/v0/b/adoptame-db.appspot.com/o/Default%2FdefaultProfile.jpg?alt=media&token=404d673e-627f-4c6d-bc5f-be02f4005985';
        ...
        print("User created successfully with default profile image");
