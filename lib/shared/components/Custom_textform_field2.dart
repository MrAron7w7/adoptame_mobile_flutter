...
class CustomTextFieldForm2 extends StatelessWidget {
  ...
  const CustomTextFieldForm2({
    ...
    this.fontSize,
    this.fontWeight, required String initialValue, required Null Function(dynamic value) onChanged,
  });
